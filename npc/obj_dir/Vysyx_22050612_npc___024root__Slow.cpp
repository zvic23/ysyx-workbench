...
void Vysyx_22050612_npc___024root___settle__TOP__1(Vysyx_22050612_npc___024root* vlSelf) {
    ...
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__pair_list[0U] = 0x99U;
    ...
    vlSelf->ysyx_22050612_npc__DOT__exu__DOT__i0__DOT__i0__DOT__key_list[0U] 
        = (7U & (vlSelf->ysyx_22050612_npc__DOT__exu__DOT__i0__DOT__i0__DOT__pair_list
                 [0U] >> 1U));
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__data_list[0U] 
        = (7U & vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__pair_list
           [0U]);
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__key_list[0U] 
        = (0x7fU & (vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__pair_list
                    [0U] >> 3U));
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__data_list[0U] 
        = (7U & vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__pair_list
           [0U]);
    ...
    vlSelf->ysyx_22050612_npc__DOT__exu__DOT__i1__DOT__i0__DOT__key_list[0U] 
        = (7U & vlSelf->ysyx_22050612_npc__DOT__exu__DOT__i1__DOT__i0__DOT__pair_list
           [0U][2U]);
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__lut_out 
        = ((- (IData)(((0x7fU & vlSelf->inst) == vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__key_list
                       [0U]))) & vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__data_list
           [0U]);
    vlSelf->ysyx_22050612_npc__DOT__opcode = vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__lut_out;
...
void Vysyx_22050612_npc___024root___ctor_var_reset(Vysyx_22050612_npc___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<1; ++__Vi0) {
        vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__pair_list[__Vi0] = VL_RAND_RESET_I(10);
    }
    for (int __Vi0=0; __Vi0<1; ++__Vi0) {
        vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__key_list[__Vi0] = VL_RAND_RESET_I(7);
    }
    for (int __Vi0=0; __Vi0<1; ++__Vi0) {
        vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__data_list[__Vi0] = VL_RAND_RESET_I(3);
    }
    vlSelf->ysyx_22050612_npc__DOT__idu__DOT__i2__DOT__i0__DOT__lut_out = VL_RAND_RESET_I(3);
