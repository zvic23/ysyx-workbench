...
void Vysyx_22050612_npc___024root__traceChgSub0(Vysyx_22050612_npc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            ...
            tracep->chgBit(oldp+130,((1U & vlSelf->ysyx_22050612_npc__DOT__exu__DOT____Vcellout__m0____pinNumber1[2U])));
            tracep->chgWData(oldp+131,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT____Vcellout__m0____pinNumber1),65);
            tracep->chgWData(oldp+134,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__m0__DOT__i0__DOT__pair_list[0]),66);
            tracep->chgBit(oldp+137,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__m0__DOT__i0__DOT__key_list[0]));
            tracep->chgWData(oldp+138,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__m0__DOT__i0__DOT__data_list[0]),65);
            tracep->chgWData(oldp+141,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__m0__DOT__i0__DOT__lut_out),65);
        }
        tracep->chgBit(oldp+144,(vlSelf->clk));
        tracep->chgBit(oldp+145,(vlSelf->rst));
        tracep->chgIData(oldp+146,(vlSelf->inst),32);
        tracep->chgQData(oldp+147,(vlSelf->pc),64);
        tracep->chgQData(oldp+149,((4ULL + vlSelf->pc)),64);
        tracep->chgQData(oldp+151,(((vlSelf->inst >> 0x1fU)
        ...
        tracep->chgCData(oldp+155,((0x1fU & (vlSelf->inst 
                                             >> 0x14U))),5);
        tracep->chgBit(oldp+156,((0x13U == (0x7fU & vlSelf->inst))));
        tracep->chgQData(oldp+157,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__gpr
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0xfU))]),64);
        tracep->chgQData(oldp+159,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__gpr
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0x14U))]),64);
        tracep->chgQData(oldp+161,((((vlSelf->inst 
                                    ...
                                    [(0x1fU & (vlSelf->inst 
                                               >> 0xfU))])),64);
        __Vtemp25[0U] = (IData)((((vlSelf->inst >> 0x1fU)
                                   ? (0xfffffffffffff000ULL 
                                      | (QData)((IData)(
                                                        (vlSelf->inst 
                                                         >> 0x14U))))
                                 ...
                                 [(0x1fU & (vlSelf->inst 
                                            >> 0xfU))]));
        __Vtemp25[1U] = (IData)(((((vlSelf->inst >> 0x1fU)
                                    ? (0xfffffffffffff000ULL 
                                       | (QData)((IData)(
                                                         (vlSelf->inst 
                                                          >> 0x14U))))
                                 ...
                                 >> 0x20U));
        __Vtemp25[2U] = 3U;
        tracep->chgWData(oldp+163,(__Vtemp25),66);
