...
void Vysyx_22050612_npc___024root__traceChgSub0(Vysyx_22050612_npc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[0U])) {
            tracep->chgCData(oldp+0,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode0__DOT__i0__DOT__pair_list[0]),2);
            tracep->chgBit(oldp+1,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode0__DOT__i0__DOT__key_list[0]));
            tracep->chgBit(oldp+2,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode0__DOT__i0__DOT__data_list[0]));
            tracep->chgCData(oldp+3,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__aa__DOT__i0__DOT__pair_list[0]),2);
            tracep->chgBit(oldp+4,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__aa__DOT__i0__DOT__key_list[0]));
            tracep->chgBit(oldp+5,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__aa__DOT__i0__DOT__data_list[0]));
        }
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            tracep->chgQData(oldp+134,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__wdata),64);
            tracep->chgBit(oldp+136,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__wen));
            tracep->chgBit(oldp+137,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__ab));
            tracep->chgBit(oldp+138,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode0__DOT__i0__DOT__lut_out));
            tracep->chgWData(oldp+139,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode1__DOT__i0__DOT__pair_list[0]),65);
            tracep->chgBit(oldp+142,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode1__DOT__i0__DOT__key_list[0]));
            tracep->chgQData(oldp+143,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode1__DOT__i0__DOT__data_list[0]),64);
            tracep->chgQData(oldp+145,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode1__DOT__i0__DOT__lut_out),64);
            tracep->chgBit(oldp+147,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__aa__DOT__i0__DOT__lut_out));
        }
        tracep->chgBit(oldp+148,(vlSelf->clk));
        tracep->chgBit(oldp+149,(vlSelf->rst));
        tracep->chgIData(oldp+150,(vlSelf->inst),32);
        tracep->chgQData(oldp+151,(vlSelf->pc),64);
        tracep->chgQData(oldp+153,((4ULL + vlSelf->pc)),64);
        tracep->chgQData(oldp+155,(((vlSelf->inst >> 0x1fU)
        ...
        tracep->chgCData(oldp+159,((0x1fU & (vlSelf->inst 
                                             >> 0x14U))),5);
        tracep->chgBit(oldp+160,((0x13U == (0x7fU & vlSelf->inst))));
        tracep->chgQData(oldp+161,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__gpr
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0xfU))]),64);
        tracep->chgQData(oldp+163,(vlSelf->ysyx_22050612_npc__DOT__exu__DOT__gpr
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0x14U))]),64);
        tracep->chgQData(oldp+165,((((vlSelf->inst 
                                    ...
                                    [(0x1fU & (vlSelf->inst 
                                               >> 0xfU))])),64);
        tracep->chgBit(oldp+167,(((0x13U == (0x7fU 
                                             & vlSelf->inst)) 
        ...
        __Vtemp8[1U] = (IData)(((((vlSelf->inst >> 0x1fU)
                                ...
                                >> 0x20U));
        __Vtemp8[2U] = 1U;
        tracep->chgWData(oldp+168,(__Vtemp8),65);
        tracep->chgBit(oldp+171,(((0x13U == (0x7fU 
                                             & vlSelf->inst)) 
                                  == vlSelf->ysyx_22050612_npc__DOT__exu__DOT__decode1__DOT__i0__DOT__key_list
                                  [0U])));
        tracep->chgBit(oldp+172,(((0x13U == (0x7fU 
                                             & vlSelf->inst)) 
