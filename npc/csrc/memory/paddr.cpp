...
//					    //
//  *(uint32_t*)&pmem[0x00000010]=0x00100093; //gpr[1](ra)+1
//  *(uint32_t*)&pmem[0x00000014]=0x00100093; //gpr[1](ra)+1
//  *(uint32_t*)&pmem[0x00000018]=0x00100093; //gpr[1](ra)+1
//  *(uint32_t*)&pmem[0x0000001c]=0x00100093; //gpr[1](ra)+1
//					    //
