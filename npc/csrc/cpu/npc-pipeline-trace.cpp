...
void IFU_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A,152);  memcpy(&A[1],z,152);  A[0] = a;
	memcpy(z,B,152);  memcpy(&B[1],z,152);  B[0] = b;
	memcpy(z,C,152);  memcpy(&C[1],z,152);  C[0] = c;
	memcpy(z,D,152);  memcpy(&D[1],z,152);  D[0] = d;
//	memcpy(z,E,152);  memcpy(&E[1],z,152);  E[0] = e;
//	memcpy(z,F,152);  memcpy(&F[1],z,152);  F[0] = f;
//	memcpy(z,G,152);  memcpy(&G[1],z,152);  G[0] = g;
//	memcpy(z,H,152);  memcpy(&H[1],z,152);  H[0] = h;
//	memcpy(z,I,152);  memcpy(&I[1],z,152);  I[0] = i;
//	memcpy(z,J,152);  memcpy(&J[1],z,152);  J[0] = j;
...
void IDU_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A1,152);  memcpy(&A1[1],z,152);  A1[0] = a;
	memcpy(z,B1,152);  memcpy(&B1[1],z,152);  B1[0] = b;
	memcpy(z,C1,152);  memcpy(&C1[1],z,152);  C1[0] = c;
	memcpy(z,D1,152);  memcpy(&D1[1],z,152);  D1[0] = d;
//	memcpy(z,E1,152);  memcpy(&E1[1],z,152);  E1[0] = e;
//	memcpy(z,F1,152);  memcpy(&F1[1],z,152);  F1[0] = f;
//	memcpy(z,G1,152);  memcpy(&G1[1],z,152);  G1[0] = g;
//	memcpy(z,H1,152);  memcpy(&H1[1],z,152);  H1[0] = h;
//	memcpy(z,I1,152);  memcpy(&I1[1],z,152);  I1[0] = i;
//	memcpy(z,J1,152);  memcpy(&J1[1],z,152);  J1[0] = j;
...
void EXU_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A2,152);  memcpy(&A2[1],z,152);  A2[0] = a;
	memcpy(z,B2,152);  memcpy(&B2[1],z,152);  B2[0] = b;
	memcpy(z,C2,152);  memcpy(&C2[1],z,152);  C2[0] = c;
	memcpy(z,D2,152);  memcpy(&D2[1],z,152);  D2[0] = d;
	memcpy(z,E2,152);  memcpy(&E2[1],z,152);  E2[0] = e;
	memcpy(z,F2,152);  memcpy(&F2[1],z,152);  F2[0] = f;
	memcpy(z,G2,152);  memcpy(&G2[1],z,152);  G2[0] = g;
	memcpy(z,H2,152);  memcpy(&H2[1],z,152);  H2[0] = h;
//	memcpy(z,I2,152);  memcpy(&I2[1],z,152);  I2[0] = i;
//	memcpy(z,J2,152);  memcpy(&J2[1],z,152);  J2[0] = j;
...
void MEM_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A3,152);  memcpy(&A3[1],z,152);  A3[0] = a;
	memcpy(z,B3,152);  memcpy(&B3[1],z,152);  B3[0] = b;
	memcpy(z,C3,152);  memcpy(&C3[1],z,152);  C3[0] = c;
	memcpy(z,D3,152);  memcpy(&D3[1],z,152);  D3[0] = d;
	memcpy(z,E3,152);  memcpy(&E3[1],z,152);  E3[0] = e;
	memcpy(z,F3,152);  memcpy(&F3[1],z,152);  F3[0] = f;
//	memcpy(z,G3,152);  memcpy(&G3[1],z,152);  G3[0] = g;
//	memcpy(z,H3,152);  memcpy(&H3[1],z,152);  H3[0] = h;
//	memcpy(z,I3,152);  memcpy(&I3[1],z,152);  I3[0] = i;
//	memcpy(z,J3,152);  memcpy(&J3[1],z,152);  J3[0] = j;
...
void WBU_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A4,152);  memcpy(&A4[1],z,152);  A4[0] = a;
	memcpy(z,B4,152);  memcpy(&B4[1],z,152);  B4[0] = b;
	memcpy(z,C4,152);  memcpy(&C4[1],z,152);  C4[0] = c;
//	memcpy(z,D4,152);  memcpy(&D4[1],z,152);  D4[0] = d;
//	memcpy(z,E4,152);  memcpy(&E4[1],z,152);  E4[0] = e;
//	memcpy(z,F4,152);  memcpy(&F4[1],z,152);  F4[0] = f;
//	memcpy(z,G4,152);  memcpy(&G4[1],z,152);  G4[0] = g;
//	memcpy(z,H4,152);  memcpy(&H4[1],z,152);  H4[0] = h;
//	memcpy(z,I4,152);  memcpy(&I4[1],z,152);  I4[0] = i;
//	memcpy(z,J4,152);  memcpy(&J4[1],z,152);  J4[0] = j;
...
void ICACHE_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A5,152);  memcpy(&A5[1],z,152);  A5[0] = a;
	memcpy(z,B5,152);  memcpy(&B5[1],z,152);  B5[0] = b;
	memcpy(z,C5,152);  memcpy(&C5[1],z,152);  C5[0] = c;
	memcpy(z,D5,152);  memcpy(&D5[1],z,152);  D5[0] = d;
	memcpy(z,E5,152);  memcpy(&E5[1],z,152);  E5[0] = e;
	memcpy(z,F5,152);  memcpy(&F5[1],z,152);  F5[0] = f;
	memcpy(z,G5,152);  memcpy(&G5[1],z,152);  G5[0] = g;
	memcpy(z,H5,152);  memcpy(&H5[1],z,152);  H5[0] = h;
	memcpy(z,I5,152);  memcpy(&I5[1],z,152);  I5[0] = i;
	memcpy(z,J5,152);  memcpy(&J5[1],z,152);  J5[0] = j;
...
void DCACHE_state_trace (long long a,long long b,long long c,long long d,long long e,long long f,long long g,long long h,long long i,long long j,long long k,long long l,long long m,long long n,long long o,long long p){
	long long z[19];
	memcpy(z,A6,152);  memcpy(&A6[1],z,152);  A6[0] = a;
	memcpy(z,B6,152);  memcpy(&B6[1],z,152);  B6[0] = b;
	memcpy(z,C6,152);  memcpy(&C6[1],z,152);  C6[0] = c;
	memcpy(z,D6,152);  memcpy(&D6[1],z,152);  D6[0] = d;
	memcpy(z,E6,152);  memcpy(&E6[1],z,152);  E6[0] = e;
	memcpy(z,F6,152);  memcpy(&F6[1],z,152);  F6[0] = f;
	memcpy(z,G6,152);  memcpy(&G6[1],z,152);  G6[0] = g;
	memcpy(z,H6,152);  memcpy(&H6[1],z,152);  H6[0] = h;
	memcpy(z,I6,152);  memcpy(&I6[1],z,152);  I6[0] = i;
	memcpy(z,J6,152);  memcpy(&J6[1],z,152);  J6[0] = j;
...
void pipeline_state_printf(){
	for(int i=19;i>=0;i--){
		...
		printf("EXU:   pc:%llx  inst:%08llx  valid:%lld  src1:%x  src2:%x  aluoutput:%x  ex_block:%d  mulvar:%b\n",A2[i],B2[i],C2[i],D2[i],E2[i],F2[i],G2[i],H2[i]);
