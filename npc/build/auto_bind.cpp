...
void nvboard_bind_all_pins(Vtop* top) {
	nvboard_bind_pin( &top->clr, BIND_RATE_SCR, BIND_DIR_IN , 1, BTNC);
	...
	nvboard_bind_pin( &top->vga_blank, BIND_RATE_RT , BIND_DIR_OUT, 1, VGA_BLANK_N);
	...
	nvboard_bind_pin( &top->capital, BIND_RATE_SCR, BIND_DIR_OUT, 1, LD0);
}
