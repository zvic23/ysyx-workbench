...
VL_INLINE_OPT void Vtop___024root___combo__TOP__1(Vtop___024root* vlSelf) {
    ...
    if ((0U == (IData)(vlSelf->mode))) {
        ...
        top__DOT__D = vlSelf->B;
        top__DOT__D = (0xfU & ((IData)(1U) + (~ (IData)(top__DOT__D))));
        vlSelf->c = (1U & (((IData)(vlSelf->A) + (IData)(top__DOT__D)) 
                           >> 4U));
        vlSelf->out = (0xfU & ((IData)(vlSelf->A) + (IData)(top__DOT__D)));
        vlSelf->z = (0U == (IData)(vlSelf->out));
        vlSelf->ovfl = (((1U & ((IData)(vlSelf->A) 
                                >> 3U)) == (1U & ((IData)(vlSelf->B) 
                                                  >> 3U))) 
