...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, word_t shamt=imm & 0x000000000000003f;word_t src1_s=src1>>shamt;
		  R(dest)=(BITS(src1,63,63)==1)?((BITS(0xffffffffffffffff,shamt-1,0)<<(64-shamt))|src1_s):src1_s);  
  //word_t shamt=BITS(imm,5,0)    sword_t src1_sign = *(sword_t*)&src1;R(dest)=(src1_sign >> shamt));        //     !!!!!!!!have doubt 
