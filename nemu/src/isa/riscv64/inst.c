...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, word_t src1_s=src1>>BITS(imm,5,0);word_t shamt=BITS(imm,5,0);R(dest)=(BITS(src1,63,63)==1)?((BITS(0xffffffff,shamt-1,0)<<(64-shamt))|src1_s):src1_s  ); //;else R(dest)=src1_s);
