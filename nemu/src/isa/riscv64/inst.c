...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, s->dnpc=isa_raise_intr(R(17),mtvec);isa_reg_display(););   
  INSTPAT("??????? ????? ????? 010 ????? 11100 11", csrrs  , I, if(BITS(imm,11,0)==0x342)R(dest)=0xb;if(BITS(imm,11,0)==0x342)mcause|=src1;
