...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, src1=0x80000000;word_t src1_s=src1>>BITS(imm,5,0);if(BITS(src1,63,63)==1) R(dest)=(BITS(0xffffffff,BITS(imm,5,0)-1,0)<<(64-BITS(imm,5,0)));else R(dest)=src1_s);
