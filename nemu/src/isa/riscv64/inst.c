...
if(BITS(src1,31,31)==BITS(src2,31,31)&&BITS(src1,31,31)==0)match=(src1>=src2)?1:0;
if(BITS(src1,31,31)==BITS(src2,31,31)&&BITS(src1,31,31)==1)match=(src1<=src2)?1:0;
if(BITS(src1,31,31)!=BITS(src2,31,31))match=(BITS(src1,31,31)==0)?1:0;
