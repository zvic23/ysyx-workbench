...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 101 ????? 11000 11", bge    , B, src1=0x1000000000000000;src2=0x0000000000000001;sword_t src1s=src1;sword_t src2s=src2;s->dnpc = (src1s>=src2s)?(s->pc+imm):s->dnpc);     //!!!!!todo
