...
//	s->dnpc = (match)?(s->pc+imm):s->dnpc);     //!!!!!have doubt and to be optimized
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R,	sword_t src1_32s=BITS(src1,31,0)<<32;sword_t src2_32s=BITS(src2,31,0)<<32;sword_t quotient=src1_32s/src2_32s;R(dest) = SEXT(quotient>>32,32)); 
