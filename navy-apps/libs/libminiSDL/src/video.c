...
//  printf("blit in\n");
	...
	//printf("dst : dw=%d,dh=%d,rx=%d,ry=%d,rw=%d,rh=%d\n",dst->w,dst->h,dstrect->x,dstrect->y,dstrect->w,dstrect->h);
	//printf("src : sw=%d,sh=%d,rx=%d,ry=%d,rw=%d,rh=%d\n",src->w,src->h,srcrect->x,srcrect->y,srcrect->w,srcrect->h);
	...
	if((src->w == src->pitch && dst->w != dst->pitch) || (src->w != src->pitch && dst->w == dst->pitch))printf("blit format is wrong/n");
	//printf("  sw=%d,sh=%d\n",srcrect_w,srcrect_h);
	if(src->w == src->pitch){
